...
public class VariableFinishLoopExampleMaker {
  UnifiedPetriNet net ;
  /*input places */
  public int iP3, iP5 ;
  /*ordinary places */
  ...
  public VariableFinishLoopExampleMaker(){
  ...
  private void addTransitions(){
    ...
    T4_vd = net.addTransitionVariableDelay(3.0, parser.parseTable(T4_vd_tableStr));
