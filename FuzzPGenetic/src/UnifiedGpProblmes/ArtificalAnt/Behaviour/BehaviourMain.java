...
import UnifiedGpProblmes.ArtificalAnt.MutableStateLogged;
...
public class BehaviourMain {
  ...
  public static void doStuff(String path, int runNr, Function<ForkJoinPool, PaleoSelector> selectorFactory) {
    ...
    ArrayList<IOperatorFactory<IBehaviourBasedFitness<UnifiedGpIndi, AntBinaryDescription>>> bfitnesCals = new ArrayList<>();
    bfitnesCals.add(AntBehaviourFitness::new);
