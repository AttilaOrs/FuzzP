...
public class FullMain {
  ...
  public static void main(String args[]) {
    ...
    for (int tryNr = 0; tryNr < 100; tryNr++) {
      ...
      gens.add(
          () -> new HalfRampHalfFull(
              new TreeBuilderCongigGeneralImpl(getProblemSpecification()),
              HALD_RANK_MAX_SIZE));
      ...
      fitnesses
          .add(() -> new FullControllMultiScenarioFitness(
      ...
      PaleoMultiobejctiveAlgo<UnifiedGpIndi> algo = new PaleoMultiobejctiveAlgo<>(pool,
          new MultiplierTransformer(forkJoin), new double[]{1.0}, crossWeigth, new double[]{1.0},
          paleoSelector);
